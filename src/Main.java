...
import data_source.QueueDataSource;
...
//task 1
        ...
        ProductsQueue productsQueue = new ProductsQueue(new QueueDataSource(new LinkedList<>()).createQueue());
...
//task 2
        System.out.println("\nЗадание 2");
        ProductsQueueExtendedVersion productsQueueExtendedVersion = new ProductsQueueExtendedVersion(new QueueDataSource(new LinkedList<>()).createQueue());
